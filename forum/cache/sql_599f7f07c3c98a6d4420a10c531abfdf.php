<?php exit; ?>
1412717015
SELECT s.style_id, c.theme_id, c.theme_data, c.theme_path, c.theme_name, c.theme_mtime, i.*, t.template_path FROM net_neutrality_styles s, net_neutrality_styles_template t, net_neutrality_styles_theme c, net_neutrality_styles_imageset i WHERE s.style_id = 2 AND t.template_id = s.template_id AND c.theme_id = s.theme_id AND i.imageset_id = s.imageset_id
63562
a:1:{i:0;a:11:{s:8:"style_id";s:1:"2";s:8:"theme_id";s:1:"2";s:10:"theme_data";s:63150:"/*  phpBB3 Style Sheet
	--------------------------------------------------------------
...
html, body {
    background: #ddeeff url({T_THEME_PATH}/images/header_g2.png) top center repeat-y;
}
body.simple { 
    width: auto; 
    margin: 0;
...
#page-body > h2, #page-body > form > h2, #page-body > h3, #page-body > form > h3, div#message h2, #confirm h2, #agreement h2, 
#page-body h2.title a, #page-body h2.title a:visited { color: #0300ac; }
#page-body h2.title a:hover { color: #5491ff; }
...
#header {
    ...
    background: #0077fc url({T_THEME_PATH}/images/header_g1.png) top left repeat-x;
    background: url({T_THEME_PATH}/images/header_g2.png) top center repeat-y, #0077fc url({T_THEME_PATH}/images/header_g1.png) top left repeat-x;
}
.old-ie #header {
    padding-bottom: 0;
}
...
#footer {
    ...
    color: #cce6ff;
    text-shadow: none;
    border-top: 2px solid #449cff;
    background: #0077fc url({T_THEME_PATH}/images/header_g2.png) top center repeat-y;
    height: 30px;
    overflow: hidden;
}
...
ul.topiclist li.header {
    margin: 0 0 2px;
    padding: 1px 0;
    border: solid 1px #2f92ff;
    background: #057bff url({T_THEME_PATH}/images/th.gif) 0 0 repeat-x;
    background: url({T_THEME_PATH}/images/header_g2.png) top center repeat-y, #057bff url({T_THEME_PATH}/images/th.gif) 0 0 repeat-x;
    border-radius: 6px;
...
.postbody h3, .postbody h3 a, .postbody h3 a:visited { color: #0060c9; }
.postbody h3 a:hover { color: #0300ac; }
...
fieldset.polls dd div {
	...
	overflow: visible;
	min-width: 12px;
	background: #0060c9 url({T_THEME_PATH}/images/poll.png) 0 0 repeat-x;
...
.syntaxkeyword	{ color: #0300ac; }
.syntaxstring	{ color: #0060c9; }
...
div.dropdown-tabs:hover > a { background-position: bottom right; color: #0300ac; }
...
.dropdown-tabs li, #tabs .dropdown-tabs li { 
    ...
    border-bottom: solid 1px #abd3ff;
}
...
";s:10:"theme_path";s:11:"art_phantom";s:10:"theme_name";s:16:"Artodia: Phantom";s:11:"theme_mtime";s:10:"1412716350";s:11:"imageset_id";s:1:"2";s:13:"imageset_name";s:16:"Artodia: Phantom";s:18:"imageset_copyright";s:18:"&copy; Artodia.com";s:13:"imageset_path";s:11:"art_phantom";s:13:"template_path";s:11:"art_phantom";}}