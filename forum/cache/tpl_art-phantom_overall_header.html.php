...
// <![CDATA[
    ...
    */
    ...
    var imagesetLang = '<?php echo (isset($this->_rootref['T_IMAGESET_LANG_PATH'])) ? $this->_rootref['T_IMAGESET_LANG_PATH'] : ''; ?>';
// ]]>
</script>
<!--[if lt IE 9]>
...
<div id="page-header">
   ...
   <div id="nav-header" class="responsive-menu-nojs">
		<div class="responsive-menu" style="display:none;">
			<?php if ($this->_rootref['L_MENU']) {  ?><a href="javascript:void(0);"><span><?php echo ((isset($this->_rootref['L_MENU'])) ? $this->_rootref['L_MENU'] : ((isset($user->lang['MENU'])) ? $user->lang['MENU'] : '{ MENU }')); ?></span></a><?php } else { ?><a href="javascript:void(0);" class="arrow"><span>&darr;&darr;&darr;</span></a><?php } ?>
