...
<html lang="en">
	...
	<div class="container">
	    ...
	    <ul class="row myMenu">
		<li id="home" class="text-center col-xs-10 col-md-2 home"><a href="index.html"><h2>Home</h2></a></li>
		...
		<li id="search" class="text-center col-xs-10 col-md-6 search reverse" ><a href="....html"><h2>Search</h2></a></li>
		...
		<div class="carousel-inner">
			...
			<a href="videos.html"><img src="images/vi-hart-net-neutrality-600x369.jpg" alt="net neutrality video"></a><!--added link-->
		...
		<h2>Recent News</h2>
		<p><?php include 'php/articlewidget.php'; ?></p>
	    </section>
	    <!--video-->
	    <section id= "video" class= "text-center col-xs-10 video" >
		<h2>...</h2>
		<p>...</p>
	    </section>
	    <!--footer-->
